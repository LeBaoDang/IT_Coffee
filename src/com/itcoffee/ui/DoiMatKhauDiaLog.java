...
public class DoiMatKhauDiaLog extends javax.swing.JDialog {
    ...
    boolean vali_date() {
        ...
        if (txtPass1.getText().trim().length() < 2 || txtPass1.getText().trim().length() > 50) {
            MsgBox.alert(this, "Mật khẩu mới có độ dài trên 2 và dưới 50 kí tự !");
            txtPass1.requestFocus();
            return false;
        }
        ...
        if (txtPass2.getText().trim().length() < 2 || txtPass2.getText().trim().length() > 50) {
            MsgBox.alert(this, "Xác nhận mật khẩu mới có độ dài trên 2 và dưới 50 kí tự !");
            txtPass2.requestFocus();
            return false;
        }
        return true;
